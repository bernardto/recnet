...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************/
  ...
  methods: {
    ...
    validerReAffection: function validerReAffection(add_ecra) {
      ...
      axios.post('/valider_reaffection_collecteur_zone', {
        ...
        if (response.data.success) {
          ...
          _this3.getListeDessuperviseursZone();
        }
      })["catch"](function (error) {});
    },
    ...
    onchangeZone: function onchangeZone() {
      ...
      if (this.value_zone.length <= 0) {
        ...
        if (this.aff_reaf_des > 1) this.getListeDessuperviseursZone();else {
          this.data_affectation.forEach(function (item_aff, index) {
            if (_this6.verifierEstDejaAttribuesuperviseur(item_aff)) {
              _this6.data_affectation.splice(_this6.data_affectation.indexOf(item_aff), 1);

              _this6.data_superviseur.push(item_aff);
            }
          });
        }
      }
    ...
    getListeDessuperviseursZone: function getListeDessuperviseursZone() {
      var _this7 = this;
      ...
      axios.post('/get_collecteur_zone', {
        ...
        response.data.data.forEach(function (item, index) {
          ...
          _this7.data_superviseur.forEach(function (item_user, index) {
    ...
    getInfoUser: function getInfoUser() {
      ...
      axios.post('/get_info_sup', {
        ...
        data.forEach(function (item, index) {
          ...
          if (!existe) {
            _this8.data_superviseur.push(item);
          }
        });
    ...
    getInfoCollNonAss: function getInfoCollNonAss() {
      ...
      axios.post('/get_coll_non_ass_zone', {
        ...
        data.forEach(function (item, index) {
          ...
          item.select = false;
          if (!existe) _this9.data_superviseur.push(item);
        });
    ...
    getInfoQuartier: function getInfoQuartier() {
      ...
      axios.post('/get_info_quartier', {
        ...
        data.forEach(function (item, index) {
          ...
          _this10.data_superviseur.push(item);
        });
      })["catch"](function (error) {});
    },
    ...
    searchsuperviseur: function searchsuperviseur() {
      var _this11 = this;
      ...
      axios.post('/rechercher_superviseur', {
        search: this.search
      }).then(function (response) {
        ...
        data.forEach(function (item, index) {
          ...
          item.select = false;
          if (!existe) _this11.data_superviseur.push(item);
        });
        _this11.dernier_page = 1;
      })["catch"](function (error) {});
    },
    verifierEstDejaAttribuesuperviseur: function verifierEstDejaAttribuesuperviseur(item) {
        ...
        switch (this.aff_reaf_des) {
          case 1:
            if (this.verifierEstDejaAttribuesuperviseur(item)) {
              this.erreurAlert();
            } else this.affectersuperviseur(item);
          ...
          case 3:
            this.data_d_affectation.forEach(function (item_aff, index) {
              if (item_aff.id === item.id) {
                ...
                _this12.affectersuperviseur(item);
              }
            });
            break;
        }
    ...
    affectersuperviseur: function affectersuperviseur(item) {
    ...
    erreurAlert: function erreurAlert() {
      var message = "";
      if (this.value_zone.length > 1) message = "Ce superviseur est déjà attribué aux zones sélectionnées";else message = "Ce superviseur est déjà attribué à la zone sélectionnée";
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css&":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css&":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../../node_modules/css-loader??ref--6-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--6-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=template&id=4cf0de1b&":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=template&id=4cf0de1b& ***!
  \*************************************************************************************************************************************************************************************************************************************/
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  ...
                  _vm.loading_data
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  !_vm.loading_data && this.data_superviseur.length > 0
                    ? _c("v-data-table", {
                        staticClass: "elevation-1",
                        attrs: {
                          headers: _vm.headers,
                          items: _vm.data_superviseur,
              ...
              _vm.dernier_page > 1
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm.aff_reaf_des > 1 && _vm.data_superviseur.length <= 0
                ? _c("div", [
                    _c("p", { staticClass: "headline mt-6" }, [
                      _vm._v(
                        "Liste vide! Choisissez les superviseurs à " +
                          _vm._s(
                            _vm.aff_reaf_des === 2
                              ? "réaffecter"
                              : "désaffecter"
              ...
              _vm.aff_reaf_des === 1 && _vm.data_affectation.length <= 0
                ? _c("div", [
                    _c("p", { staticClass: "text-h6 mt-6" }, [
                      _vm._v(
                        "Liste vide! Choisissez les superviseurs à affecter au(x) zone(s) sélectionnée(s)"
                      )
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "d-flex justify-center " }, [
              ...
              _c(
                ...
                [
                  _c("p", { staticClass: "headline font-weight-black" }, [
                    _vm._v(
                      "Aucun superviseur est affecté à " +
                        _vm._s(
                          _vm.value_zone.length > 1
                      ...
                      "\n                    " +
                        _vm._s(
                          _vm.data_r_affectation.length > 1
                            ? "Attention les superviseurs ne seront plus rattachés à une zone "
...
/***/ "./resources/js/components/Collecteur/AffecterSuperviseurZone.vue":
/*!************************************************************************!*\
  !*** ./resources/js/components/Collecteur/AffecterSuperviseurZone.vue ***!
  \************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _AffecterSuperviseurZone_vue_vue_type_template_id_4cf0de1b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AffecterSuperviseurZone.vue?vue&type=template&id=4cf0de1b& */ "./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=template&id=4cf0de1b&");
/* harmony import */ var _AffecterSuperviseurZone_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AffecterSuperviseurZone.vue?vue&type=script&lang=js& */ "./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _AffecterSuperviseurZone_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css& */ "./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _AffecterSuperviseurZone_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _AffecterSuperviseurZone_vue_vue_type_template_id_4cf0de1b___WEBPACK_IMPORTED_MODULE_0__["render"],
  _AffecterSuperviseurZone_vue_vue_type_template_id_4cf0de1b___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Collecteur/AffecterSuperviseurZone.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************!*\
  !*** ./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./AffecterSuperviseurZone.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css&":
/*!*********************************************************************************************************!*\
  !*** ./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css& ***!
  \*********************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader!../../../../node_modules/css-loader??ref--6-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--6-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=template&id=4cf0de1b&":
/*!*******************************************************************************************************!*\
  !*** ./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=template&id=4cf0de1b& ***!
  \*******************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_template_id_4cf0de1b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./AffecterSuperviseurZone.vue?vue&type=template&id=4cf0de1b& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Collecteur/AffecterSuperviseurZone.vue?vue&type=template&id=4cf0de1b&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_template_id_4cf0de1b___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AffecterSuperviseurZone_vue_vue_type_template_id_4cf0de1b___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
