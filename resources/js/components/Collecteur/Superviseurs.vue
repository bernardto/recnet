                                        ...
                                        <v-row>
                                            <v-col  cols="4">
                                                ...
                                                <div v-else>
                                                    ...
                                                    <div v-if="editedItem.photo === 'Aucune' ">
                                                        <v-avatar
                                                            size="128px"
...
export default {
    ...
    methods: {
        ...
        imprimerListe() {
            ...
            let valeur_tri = 0;
            let titre_impression = "LISTE DES SUPERVISSEURS DE LA MAIRIE DE YAMOUSSOUKRO";
            ...
            axios.post(url,formData, config)
                .then(response => {
                    ...
                    if (response.data.success) {
                        ...
                        if(this.editedItem.photo === 'Aucune' && this.editedIndex === -1){
        ...
        getMatricule(){
            ...
            axios.post('/get_matricule_superviseur').then(  response => {
